...
import { useModal } from '../Modals/ImageModal/useModal';
import { useTranslation } from 'react-i18next';

const Project: React.FC<Props> = ({ image, name, links, text, stack }) => {
    const { isShown, toggle } = useModal();
    const {t, i18n}  = useTranslation();
    return (
        <>
            <div className="project">
                <div className="project__image" onClick={toggle}>
                    <img src={image} alt="" />
                    <div className="project__overlay">
                        <div className="project__overlayText">{t('project.overlayText')}</div>
                    </div>
                </div>
                ...
                <ImageModal isShown={isShown} hide={toggle} image={image} />
            </div>
        </>
    );
}
