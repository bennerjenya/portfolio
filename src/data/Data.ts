...
export const projects: Props[] = [
  ...
  {
    name: 'Pravoznay',
    image: require('../assets/pravoznay.jpg'),
    links: ['', 'http://devmirror1.ru/'],
    stack: 'Next - TS - Styled-Components - Formik - Yup',
    text: 'Website',
  },
  {
    name: 'Vega-prom',
    image: require('../assets/vega-prom.jpg'),
    links: ['', 'https://vega-prom.com/'],
    stack: 'Next - TS - Styled-Components - Formik - Yup',
    text: 'Website',
  },
];
...
export const data: TabProps[] = [
  ...
  {
    position: 'Middle Frontend Developer (Remote)',
    period: 'Sep 2022 - current',
    location: 'Ekaterinburg / Russia',
    responsibilities: ['- Developing UI using NextJS', '- Better knowledge of NextJS', '- Started working in a new position'],
    name: 'Company',
  },
];
